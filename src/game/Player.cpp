...
void Player::UpdateZone(uint32 newZone, uint32 newArea)
{
    ...
    if((zone->flags & AREA_FLAG_SANCTUARY) || (GetAreaId() == 268) || (GetAreaId() == 1741) || (GetAreaId() == 477) || (GetAreaId() == 1577) || (GetAreaId() == 1519) || (GetAreaId() == 1637) || (GetAreaId() == 1497) || (GetAreaId() == 1638) || (GetAreaId() == 1537) || (GetAreaId() == 1657) || (GetAreaId() == 3487) || (GetAreaId() == 3557) || (GetAreaId() == 1577))
    {
...
void Player::SendInitWorldStates(uint32 zoneid, uint32 areaid)
{
    ...
    FillInitialWorldState(data, count, 0xF3D, sWorld.getConfig(CONFIG_UINT32_ARENA_SEASON_ID));
                                                            // 9 0 - WG in progress, 1 - otherwise
    FillInitialWorldState(data, count, 0xED9, 0x1);
                                                            // 10 WG Timer in seconds
...
bool Player::LoadFromDB( uint32 guid, SqlQueryHolder *holder )
{
    ...
    if(m_bgData.bgInstanceID)                                                //saved in BattleGround
    {
        ...
        {
            BattleGroundQueueTypeId bgQueueTypeId = BattleGroundMgr::BGQueueTypeId(currentBg->GetTypeID(true), currentBg->GetArenaType());
